...
I am a aspiring Data analyst with great interst in data analysis, and visualizaion.

###  🛠️ Tools

-  Language: SQL, Python
-  Database: MySqL, Keegle
-  Visualizaion: Power BI
-  Spreadsheet: Excel

### 🙋🏻‍♀️ Connect with me
-  [Linkedin](linkedin.com/in/akasamrat)
-  hire me on upwork [Upwork](https://www.upwork.com/freelancers/~01409a444c72406998?mp_source=share)
<!--
**SamratBhattarai-git/SamratBhattarai-git** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
